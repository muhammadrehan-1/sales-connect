...
import 'package:connect_sales/utils/helping_widgets/category_home.dart';
              ...
              Stack(
                children: [
                  SizedBox(
                    height: 46,
                    width: 46,
                    child: SvgPicture.asset('assets/icons/notification_button.svg'),
                  ),
                  Positioned(
                    bottom: 30,
                    left: 30,
          ...
          Expanded(
            child: GridView.builder(
                ...
                itemBuilder: (BuildContext context, int item) {
                  return CategoryHome(
                      image: dummyCategories[item].image,
                      name: dummyCategories[item].name);
                }),
          ),
        ],
    );
